                            ...
                            <tbody id="myTableBody">
                                @foreach ($data as $key => $item)
                                    ...
                                    <tr class="align-items-center">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU1 }}" value="{{ old('KU1', $item->KU1) }}" name='KU1' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU1');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU2 }}" value="{{ old('KU2', $item->KU2) }}" name='KU2' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU2');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU3 }}" value="{{ old('KU3', $item->KU3) }}" name='KU3' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU3');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU4 }}" value="{{ old('KU4', $item->KU4) }}" name='KU4' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU4');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU5 }}" value="{{ old('KU5', $item->KU5) }}" name='KU5' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU5');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU6 }}" value="{{ old('KU6', $item->KU6) }}" name='KU6' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU6');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU7 }}" value="{{ old('KU7', $item->KU7) }}" name='KU7' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU7');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU8 }}" value="{{ old('KU8', $item->KU8) }}" name='KU8' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU8');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KU9 }}" value="{{ old('KU9', $item->KU9) }}" name='KU9' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KU9');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P1 }}" value="{{ old('P1', $item->P1) }}" name='P1' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P1');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P2 }}" value="{{ old('P2', $item->P2) }}" name='P2' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P2');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P3 }}" value="{{ old('P3', $item->P3) }}" name='P3' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P3');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P4 }}" value="{{ old('P4', $item->P4) }}" name='P4' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P4');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P5 }}" value="{{ old('P5', $item->P5) }}" name='P5' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P5');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P6 }}" value="{{ old('P6', $item->P6) }}" name='P6' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P6');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->P7 }}" value="{{ old('P7', $item->P7) }}" name='P7' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'P7');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK1 }}" value="{{ old('KK1', $item->KK1) }}" name='KK1' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK1');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK2 }}" value="{{ old('KK2', $item->KK2) }}" name='KK2' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK2');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK3 }}" value="{{ old('KK3', $item->KK3) }}" name='KK3' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK3');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK4 }}" value="{{ old('KK4', $item->KK4) }}" name='KK4' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK4');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK5 }}" value="{{ old('KK5', $item->KK5) }}" name='KK5' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK5');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK6 }}" value="{{ old('KK6', $item->KK6) }}" name='KK6' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK6');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK7 }}" value="{{ old('KK7', $item->KK7) }}" name='KK7' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK7');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK8 }}" value="{{ old('KK8', $item->KK8) }}" name='KK8' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK8');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK9 }}" value="{{ old('KK9', $item->KK9) }}" name='KK9' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK9');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                        <form action="/editcpmk/{{ $item->id }}" method="POST">
                                        ...
                                        @method('PUT')
                                            <td class="kuk">
                                                <input type="text" placeholder="{{ $item->KK10 }}" value="{{ old('KK10', $item->KK10) }}" name='KK10' class="nilai-input text-center kuk" data-id="{{ $item->id }}" onclick="return confirmAndSubmitForm('{{ $item->id }}', 'KK10');" />
                                                <input type="hidden" name="prodi_filter" value="{{ $prodiFilter }}">
                                            </td>
                                        </form>
                                    </tr>
